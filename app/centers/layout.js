    ...
    <HomeLayout>
          ...
          <div className="max-w-[1200px] mx-auto ">
            <div className="">
              ...
              <img className="w-full h-full object-cover" src="https://cdnstatic.nextias.com/assets/images/delhi-banner.jpg" />
              <div className="flex absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <Link href="delhi" className="px-4 ">
                  <span>
                    {" "}
                    <svg
                ...
                <Link href="bhopal" className="flex flex-col items-center px-2 ">
                  <span>
                    <svg
                ...
                <Link href="jaipur" className="flex flex-col px-2 ">
                  <span>
                    {" "}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
