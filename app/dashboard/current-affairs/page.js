...
import AccordionLeftCA from "@/app/daily-current-affairs/AccordionLeftCA";
import {editorailAnalysis,accordionContent} from '../../daily-current-affairs/accordionData'
import { FaArrowRight } from "react-icons/fa";

export default function CAffairsDashboard(){
    ...
    return(
        <>
             <section className=" w-full flex flex-col md:flex-row gap-2 py-4 "style={{height:'calc(100vh - 8rem)'}}>
