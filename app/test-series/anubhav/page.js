    ...
    return(
        <>
          ...
          <div className="max-w-[1200px] mx-auto ">
            <h1 className="text-4xl my-4">Anubhav (All India Open Mock Test)</h1>
     
            <p className="py-4">
            Check out the Anubhav (All India Open Mock Test) which provides the aspirants with the platform to test themselves adequately before moving to the real UPSC exam hall. All these tests are cautiously designed as per the evolving trends of CSE so as to enable the aspirants to become adaptable to such dynamic questions competently.
            </p>
